import { HomePlanType, LotType, CombinationType } from "../types";

const getHomePlans = async (): Promise<HomePlanType[]> => [
  {
    homePlanId: 1,
    name: "The Medita",
    numBeds: 4,
...
const getLots = async (): Promise<LotType[]> => [
  {
    lotId: 1,
...
const getCombinations = async (): Promise<CombinationType[]> => [
...
export default { getHomePlans, getLots, getCombinations };
